<template>
  <PageWrapper dense contentFullHeight contentClass="flex">
    ...
    <CaseModal @register="registerDrawer" @success="handleSuccess" />
  </PageWrapper>
</template>
<script lang="ts">
  ...
  import CaseModal from './CaseDrawer.vue';
  export default defineComponent({
    name: 'PageObject',
    components: { BasicTable, TableAction, PageWrapper, Space, CaseModal },
    setup() {
      const { t } = useI18n();
